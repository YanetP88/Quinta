...
angular.module('ultimateDataTableServices', []).factory('datatable', ['$http', '$filter', '$parse', '$window', '$q', 'udtI18n', '$timeout', function ($http, $filter, $parse, $window, $q, udtI18n, $timeout) { //service to manage datatable
            ...
            getSaveRemoteRequest: function (value, i) {
                ...
                if (urlFunction) {
                    if (this.config.save.batch) {
                        ...
                        var valueFunction = this.getValueFunction(this.config.save.value);
                        httpConfig.index = i;
                        return $http[method](urlFunction(value), valueFunction(value), httpConfig).success(function (data, status, headers, config) {
...
angular.module('ultimateDataTableServices').//If the select or multiple choices contain 1 element, this directive select it automaticaly
...
angular.module('ultimateDataTableServices').directive('udtBtselect', ['$parse', '$document', '$window', '$filter', function ($parse, $document, $window, $filter) {
...
angular.module('ultimateDataTableServices').directive("udtCell", function () {
    return {
        restrict: 'A',
        replace: true,
        templateUrl: 'udt-cell.html',
        link: function (scope, element, attr) {
            if (!scope.udtTableFunctions) {
                scope.udtTableFunctions = {};
            }
...
angular.module('ultimateDataTableServices').directive('udtChange', ['$interval', function ($interval) {
    return {
        require: 'ngModel',
...
angular.module('ultimateDataTableServices').directive('udtCompile', ['$compile', function ($compile) {
...
angular.module('ultimateDataTableServices').//This directive convert the ngModel value to a view value and then the view value to the ngModel unit value
...
angular.module('ultimateDataTableServices').//Convert the date in format(view) to a timestamp date(model)
...
angular.module('ultimateDataTableServices').//Write in an input or select in a list element the value passed to the directive when the list or the input ngModel is undefined or empty
...
angular.module('ultimateDataTableServices').directive('udtForm', function () {
    return {
        restrict: 'A',
        replace: true,
        transclude: true,
...
angular.module('ultimateDataTableServices').directive("udtHtmlFilter", function ($filter) {
    return {
        require: 'ngModel',
...
angular.module('ultimateDataTableServices').directive('udtMessages', function () {
    return {
        restrict: 'A',
        replace: true,
...
angular.module('ultimateDataTableServices').directive('udtTable', function () {
    return {
        restrict: 'A',
        replace: true,
...
angular.module('ultimateDataTableServices').directive('udtTextareaResize', function () {
    return {
        restrict: 'A',
        require: 'ngModel',
        replace: false,
...
angular.module('ultimateDataTableServices').directive('udtToolbar', function () {
    return {
        restrict: 'A',
        replace: true,
...
"use strict";
angular.module('ultimateDataTableServices').directive('ultimateDatatable', ['$parse', '$q', '$timeout', '$templateCache', function ($parse, $q, $timeout, $templateCache) {
    return {
        restrict: 'A',
        replace: true,
        scope: true,
        ...
        link: function (scope, element, attr) {
            ...
            scope.udtTableFunctions.setNumberRecordsPerPage = function (elt) {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.setNumberRecordsPerPage(elt)
                }).then(function () {
            ...
            scope.udtTableFunctions.setPageNumber = function (page) {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.setPageNumber(page)
                }).then(function () {
                    if (!scope.udtTable.isRemoteMode(scope.udtTable.config.pagination.mode)) {
                        scope.udtTable.computeDisplayResultTimeOut.then(function () {
                            scope.udtTable.setSpinner(false);
            ...
            scope.udtTableFunctions.setOrderColumn = function (column) {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.setOrderColumn(column)
                }).then(function () {
            ...
            scope.udtTableFunctions.setHideColumn = function (column) {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.setHideColumn(column)
                }).then(function () {
                    scope.udtTable.setSpinner(false);
                });
            };
            ...
            scope.udtTableFunctions.setGroupColumn = function (column) {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.setGroupColumn(column)
                }).then(function () {
                    scope.udtTable.computeDisplayResultTimeOut.then(function () {
                        scope.udtTable.setSpinner(false);
                    });
            ...
            scope.udtTableFunctions.exportCSV = function (exportType) {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.exportCSV(exportType)
                }).then(function () {
                    scope.udtTable.setSpinner(false);
                });
            };
            ...
            scope.udtTableFunctions.updateShowOnlyGroups = function () {
                scope.udtTable.setSpinner(true);
                $timeout(function () {
                    scope.udtTable.updateShowOnlyGroups()
                }).then(function () {
                    scope.udtTable.computeDisplayResultTimeOut.then(function () {
                        scope.udtTable.setSpinner(false);
                    });
...
angular.module('ultimateDataTableServices').filter('udtCollect', ['$parse', function ($parse) {
...
angular.module('ultimateDataTableServices').filter('udtConvert', ['udtConvertValueServices', function (udtConvertValueServices) {
...
angular.module('ultimateDataTableServices').filter('udtUnique', ['$parse', function ($parse) {
...
angular.module('ultimateDataTableServices').factory('udtConvertValueServices', [function () {
...
angular.module('ultimateDataTableServices')./* A I18n service, that manage internal translation in udtI18n
        ...
        var udtI18n = {
            ...
            translateTable: {
                ...
                "en": {
                    ...
                    "datatable.remove.confirm": "está seguro de desea eliminar el proyecto seleccionado?",
...
"use strict";
angular.module('ultimateDataTableServices').run(['$templateCache', function ($templateCache) {
