...
angular.module('ultimateDataTableServices').directive('udtCompile', function ($compile) {
...
angular.module('ultimateDataTableServices').filter('udtUnique', function ($parse) {
...
angular.module('ultimateDataTableServices').factory('udtI18n', [function () {
...
"use strict";
angular.module('ultimateDataTableServices').run(function ($templateCache) {
