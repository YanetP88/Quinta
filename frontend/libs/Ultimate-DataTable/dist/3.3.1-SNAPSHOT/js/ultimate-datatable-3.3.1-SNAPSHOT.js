/*! ultimate-datatable version 3.3.1-SNAPSHOT 2017-05-12 
...
angular.module('ultimateDataTableServices', []).factory('datatable', ['$http', '$filter', '$parse', '$window', '$q', 'udtI18n', '$timeout', '$anchorScroll', '$location',
                ...
                getSaveRemoteRequest: function (value, i) {
                    ...
                    if (urlFunction) {
                        if (this.config.save.batch) {
                            ...
                            var valueFunction = this.getValueFunction(this.config.save.value);
                            httpConfig.index = i;
                            return $http[method](urlFunction(value), valueFunction(value), httpConfig).then(function (resp) {
...
angular.module('ultimateDataTableServices').directive('udtChange', function () {
    return {
        require: 'ngModel',
...
angular.module('ultimateDataTableServices').directive("udtHtmlFilter", function ($filter, udtI18n) {
    return {
        require: 'ngModel',
